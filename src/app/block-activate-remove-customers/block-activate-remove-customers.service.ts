...
export class BlockActivateRemoveCustomerService {
    ...
    blockCustomer(customerId: number){
        return this.httpClient.put('https://localhost:8443/authentication-service/api/blockActivateRemoveCustomer/block/' + customerId, null);
    }

    activateCustomer(customerId: number){
        return this.httpClient.put('https://localhost:8443/authentication-service/api/blockActivateRemoveCustomer/activate/' + customerId, null);
    }
