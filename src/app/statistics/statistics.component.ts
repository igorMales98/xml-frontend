...
export class StatisticsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.statisticsService.getCarsForRatingStatistics(this.loggedInUser.id).subscribe(data => {
      this.carsForRatingStatistics = data;
      for (const car of this.carsForRatingStatistics) {
        ...
        this.rents.push(car.timesRented);
        this.chartLabels2.push(car.carBrand.name + ' ' + car.carModel.name);
        this.mileages.push(car.rentMileage);
      }
      this.ratings.push(0);
      this.chartDatasets = [{
        data: this.ratings,
